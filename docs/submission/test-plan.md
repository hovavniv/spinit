...
57 test files as of this branch (`feat/spotify-connect`), before merge -- up from 46 at
slice B's merge, as the Spotify work has landed 15+ commits of its own test files since.
One test in
